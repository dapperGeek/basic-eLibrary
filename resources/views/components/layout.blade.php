		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="/" class="nav-link "><span class="pcoded-micon"><i class="feather icon-book"></i></span><span class="pcoded-mtext">Library</span></a>
					</li>
					<li class="nav-item">
					    <a href="/books/checked-out" class="nav-link "><span class="pcoded-micon"><i class="feather icon-arrow-up"></i></span><span class="pcoded-mtext">Checked Out Books</span></a>
					</li>
					...
					<li class="nav-item">
					    <a href="/users" class="nav-link "><span class="pcoded-micon"><i class="feather icon-book"></i></span><span class="pcoded-mtext">All Users</span></a>
					</li>
				</ul>
			</div>
		</div>
